...
import { createSkyDome } from '../objects/SkyDome.js'; // Changed from Sky to SkyDome
...
export class Scene extends THREE.Scene {
  constructor() {
    ...
    // Replaced the complex Sky with your simpler SkyDome
    const skyDome = createSkyDome();
    this.add(skyDome);

    this.sun = new THREE.Vector3();
    
    // Initialize fog before calling updateSky so its color can be set.
