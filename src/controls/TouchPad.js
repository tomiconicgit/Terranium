...
  // Treat anything inside these containers as UI (donâ€™t start look there)
  _isUITarget(el) {
...
    // Camera look â€” do not preventDefault on UI touches
...
  // ---- Camera look ----
  onLookStart(event) {
    if (this.paused) return; // panel open â†’ ignore look startup
...
        event.preventDefault(); // only while weâ€™re actively rotating the camera
        break;
      }
    }
  }
