...
export function createTerrain() {
    ...
    for (let i = 0; i < vertices.length; i += 3) {
        ...
        vertices[i + 2] = -fbm(x * 5, y * 5, 6) * 10; // Increased octaves and scale for more detailed, crater-like terrain
    }
    ...
    displacement1.wrapS = displacement1.wrapT = THREE.RepeatWrapping;
    displacement1.repeat.set(5, 5);

    const normalMap1 = exrLoader.load('src/assets/textures/moon/moondusted/moondusted-normal.exr');
    normalMap1.wrapS = normalMap1.wrapT = THREE.RepeatWrapping;
    normalMap1.repeat.set(5, 5);

    const roughnessMap1 = exrLoader.load('src/assets/textures/moon/moondusted/moondusted-roughness.exr');
    roughnessMap1.wrapS = roughnessMap1.wrapT = THREE.RepeatWrapping;
    roughnessMap1.repeat.set(5, 5);
    ...
    roughnessMap2.wrapS = roughnessMap2.wrapT = THREE.RepeatWrapping;
    roughnessMap2.repeat.set(5, 5);
    ...
    normalMap3.wrapS = normalMap3.wrapT = THREE.RepeatWrapping;
    normalMap3.repeat.set(5, 5);

    const roughnessMap3 = exrLoader.load('src/assets/textures/moon/moonnormal/moonnormal-roughness.exr');
    roughnessMap3.wrapS = roughnessMap3.wrapT = THREE.RepeatWrapping;
    roughnessMap3.repeat.set(5, 5);
    ...
    const material = new THREE.MeshStandardMaterial({
        ...
        displacementScale: 5,
        displacementBias: -2.5, // Adjust based on texture range
        side: THREE.DoubleSide
    });

    // Custom shader for blending
